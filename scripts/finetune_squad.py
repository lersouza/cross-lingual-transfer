...
from crosslangt.qa.model import BERTSQuADFinetuneModel
...
logger = logging.getLogger('finetune_squad')
...
def finetune(hyperparameters):
    ...
    model = BERTSQuADFinetuneModel(hyperparameters)
...
def main():
    ...
    parser.add_argument('--checkpoint_path', type=str,
                        default='data/checkpoints/squad/')

    parser = BERTSQuADFinetuneModel.add_model_specific_args(parser)
