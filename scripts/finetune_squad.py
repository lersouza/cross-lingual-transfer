...
I added some functionality to freeze lexical part and did some code formatting

The License header is preserved.

Finetuning the library models for question-answering
on SQuAD (DistilBERT, Bert, XLM, XLNet).
"""
...
def main():
    ...
    parser.add_argument(
        '--freeze_lexical',
        action='store_true',
        help='Indicates if the Lexical part of the model should be freezed.'
    )
    parser.add_argument(
        '--lexical',
        type=str,
        default=None,
        help='If specified, replace the model\'s lexical part with this '
    ...
    parser.add_argument(
        ...
        + "If no data dir or train/predict files are specified, will run with "
        + "tensorflow_datasets.",
    )
    parser.add_argument(
        "--train_file",
        default=None,
        type=str,
        help="The input training file. If a data dir is specified, will look "
             "for the file there "
